 <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark"> <!--begin::Sidebar Brand-->
     <div class="sidebar-brand"> <!--begin::Brand Link-->
         <a href="#" class="brand-link"> <!--begin::Brand Image-->
             <img src="{{ asset('images/cict-logo.png') }}" alt="AdminLTE Logo" class="brand-image opacity-75 shadow">
     ...
     <div class="sidebar-wrapper" data-overlayscrollbars="host">
             ...
             <nav class="mt-2">
                 ...
                 <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu"
                     ...
                     @if (Auth::user()->role == '0')
                         ...
                         <li class="nav-item">
                             <a href="{{ route('admin.intern-application') }}" class="nav-link">
                                 <p>Intern Application</p>
                             </a>
                         </li>
                         <li class="nav-item">
                     ...
                     @if (Auth::user()->role == '3')
                         ...
                         @if (Auth::user()->approved == 1)
                             ...
                             <li class="nav-item">
                                 ...
                                 <a href="{{ route('stud.submitted-reports') }}" class="nav-link">
                                     <p>
         ...
         <div
             ...
             <div class="os-scrollbar-track">
                 <div class="os-scrollbar-handle" style="height: 24.843%;"></div>
             </div>
         </div>
     </div>
     <!--end::Sidebar Wrapper-->
