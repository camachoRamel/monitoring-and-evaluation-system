    ...
    <div class="modal fade" id="delete-modal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            ...
            <div class="modal-header">
                <div class="col">
                    <h3 class="modal-title text-danger" id="deleteModalLabel">YOU WILL BE DELETING COORDINATOR:</h3>
                    <h4 class="fw-bold">{{ $worker->first_name . ' ' . $worker->middle_name . ' ' . $worker->last_name }}</h4>
                </div>
            ...
            <div class="modal-footer">
                ...
                <form action="{{ route("admin.delete", ['id' => $worker->id, 'role' => 2]) }}" method="POST">
                    @csrf
